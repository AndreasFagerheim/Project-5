...
int main()
{
   ...
   // Integrand *integrandVerlet = new Integrand(dt, false);
    ...
    ofstream filEnergi;
    filEnergi.open("C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/energiVerlet.txt");
    ...
    string filNavn = "C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/SolJordFixedEuler.txt";
