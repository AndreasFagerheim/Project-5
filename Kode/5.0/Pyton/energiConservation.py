...
k,p,tot,aM = Read_four_Column_File('C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/energiEuler.txt')
...
plt.savefig('C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/plotEulerKinetisk.png')
plt.show()
plt.figure()
plt.plot(t,p)
plt.legend(bbox_to_anchor=(0.8, 1), loc='upper left', borderaxespad=0.)
...
plt.ylabel('kinetic energy  [kg (Au/year)^2]')
plt.xlabel('Time [year]')
plt.savefig('C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/plotEulerPotensiel.png')
plt.show()
plt.figure()
k2,p2,t,aM2 = Read_four_Column_File('C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/energiVerlet.txt')
t = np.linspace(0.0,1.0,len(k))
#plt.plot(x,y,label="euler")
plt.plot(t,k2)
plt.legend(bbox_to_anchor=(0.8, 1), loc='upper left', borderaxespad=0.)
...
plt.ylabel('kinetic energy  [kg (Au/year)^2]')
plt.xlabel('Time [year]')
plt.savefig('C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/plotKinetiskVerlet.png')
plt.show()
plt.figure()
...
plt.xlabel('Time [year]')
plt.savefig('C:/Users/Andreas/Documents/Project 5/Project-5/Data/Class/plotVerletPotensiel.png')
plt.show()
plt.figure()
